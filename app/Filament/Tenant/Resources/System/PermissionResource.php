...
use App\Filament\Tenant\Resources\System\PermissionResource\Pages;
use App\Filament\Tenant\Resources\System\PermissionResource\RelationManagers;
    ...
    protected static function getTableFilters(): array
    {
        return [
            ...
            Tables\Filters\Filter::make('created_at')
                ...
                ->indicateUsing(
                    fn(PermissionService $service, mixed $state): ?string =>
